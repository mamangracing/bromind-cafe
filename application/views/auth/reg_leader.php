                            ...
                            <div class="col-lg">
                                <div class="py-5 px-4">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Create a Leader Account!</h1>
                                    </div>
                                    <form method="post" action="<?= base_url('auth/reg_leader'); ?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="password" class="form-control form-control-user"
                                                    id="assword2" name="password2" placeholder="Repeat Password">
                                            </div>
                                        </div>
